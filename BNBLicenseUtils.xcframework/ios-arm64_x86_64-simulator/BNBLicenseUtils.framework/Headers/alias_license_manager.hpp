...
class BNB_EXPORT alias_license_manager {
public:
    virtual ~alias_license_manager() {}

    /** Creates *new* `LicenceManager`. This metod won't change Banuba SDK internal state. */
    static std::shared_ptr<alias_license_manager> create(const std::string & client_token);

    /**
     * Returns the instance used by Banuba SDK to check licence.
     * This istance was created by `UtilityManager.initialize`.
     */
    static std::shared_ptr<alias_license_manager> instance();
